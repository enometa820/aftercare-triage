...
> 성형·피부 **시술 후 회복기** 환자를 텍스트+사진으로 받아, **정상 경과는 다국어로 안심시키고 · 불확실하거나 이상징후는 기권(defer)해 의사에게 에스컬레이션**하는 AI 사후케어 트리아지 모듈.
>
> 핵심 명제 — **"AI의 정확도가 아니라, 못 믿을 때를 알고 사람에게 넘기는 능력을 증명한다"(측정된 안전).**
...
- [`BP-기술-베스트프랙티스.md`](BP-기술-베스트프랙티스.md) — 구현 기술 베스트프랙티스 (준비 중)
